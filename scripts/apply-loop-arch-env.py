...
UPDATES = {
    ...
    "PULSE_PRE_TRADE_MIN_SCORE": "0.10",
    "PULSE_PRE_TRADE_EXPLORATION_RATE": "0.30",
    "PULSE_BINARY_INTEL_MIN_SCORE": "0.10",
    "PULSE_BINARY_INTEL_EXPLORATION_RATE": "0.30",
    ...
    "PULSE_SAWR_STARVE_FPH": "0.6",
    "PULSE_SAWR_RICH_FPH": "4.0",
    "PULSE_SAWR_WR_WEIGHT": "1.0",
    "PULSE_SAWR_FILL_WEIGHT": "0.35",
    "PULSE_SAWR_KILL_PENALTY": "2.0",
    "PULSE_SAWR_COOLDOWN": "5",
    # CHRONOS off during training throughput — observe-only in code when mode=1 anyway.
